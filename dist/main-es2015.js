...
let AppComponent = class AppComponent {
    constructor() {
        ...
        this.resRough$ = this.full$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((fullForm) => {
    ...
    dmg() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["combineLatest"])([this.resRough$, this.full$]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(([results, form]) => {
    ...
    res() {
        return this.resRough$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])((resArray) => {
